...
const products = [
  {
    icon: Monitor,
    title: "Clipe233 School Management System",
    subtitle: "Education Administration Platform",
    description:
  ...
  {
    icon: Database,
    title: "Clipe233 Inventory Manager",
    subtitle: "Stock Control Platform",
    description:
      "An intelligent inventory management platform that helps businesses track stock levels, manage suppliers, automate reordering, and gain full visibility into their supply chain. Designed to reduce waste, prevent stockouts, and optimise purchasing decisions with real-time data and actionable insights.",
    features: [
  ...
  {
    icon: Cloud,
    title: "Clipe233 Cloud Backup",
    subtitle: "Data Protection Solution",
    description:
      "A secure, automated cloud backup solution that protects your critical business data from loss, corruption, and disasters. With encrypted storage, scheduled backups, and rapid recovery capabilities, your organisation's data remains safe and accessible whenever you need it, ensuring business continuity at all times.",
    features: [
...
const highlights = [
  ...
  { icon: Zap, label: "Easy to Deploy" },
  { icon: Shield, label: "Secure & Reliable" },
  { icon: Monitor, label: "User Friendly" },
