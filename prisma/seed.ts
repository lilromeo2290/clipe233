...
async function main() {
  ...
  const testimonials = [
    {
      ...
      content: "Clipe233 Engineers transformed how our schools manage operations. Their school management system reduced our administrative workload by 60% and improved parent engagement significantly. The team was professional, responsive, and truly understood our unique requirements as an educational institution.",
      rating: 5,
      featured: true,
      published: true,
    },
    {
      ...
      content: "The e-commerce platform built by Clipe233 Engineers has been a game-changer for our retail business. Within three months of launch, our online sales exceeded our physical store revenue. Their attention to user experience and payment integration was exceptional.",
      rating: 5,
      featured: true,
      published: true,
    },
    {
      ...
      company: "Dzodze",
      content: "From our website to the live streaming setup, Clipe233 Engineers delivered everything perfectly. Our online viewers and listeners has grown. They understood the spiritual and technical needs of our ministry and exceeded all expectations.",
      rating: 5,
      featured: true,
      published: true,
    },
  ...
  // ─── Site Settings ─────────────────────────────────────────────────────────
  const settings = [
    { key: "site_name", value: "Clipe233 Engineers" },
    ...
    // Page metadata
    { key: "home_title", value: "Clipe233 Engineers — IT & Engineering Solutions" },
    ...
    { key: "home_hero_subheading", value: "Clipe233 Engineers delivers innovative software, networking, branding, and digital transformation solutions tailored for businesses and organizations across Ghana and beyond." },
    { key: "about_title", value: "About Clipe233 Engineers" },
    { key: "about_description", value: "From our founding in 2016 as Clipe Technologies to our rebranding as Clipe233 Engineers in 2025, we have been dedicated to engineering digital possibilities." },
    { key: "contact_title", value: "Contact Clipe233 Engineers" },
